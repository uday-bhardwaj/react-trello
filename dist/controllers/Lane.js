...
class Lane extends _react.Component {
  constructor(...args) {
    ...
    (0, _defineProperty2.default)(this, "onDragEnd", /*#__PURE__*/function () {
      var _ref = (0, _asyncToGenerator2.default)(function* (laneId, result) {
        const handleDragEnd = _this.props.handleDragEnd;
        ...
        if (addedIndex != null) {
          ...
          const response = handleDragEnd ? yield handleDragEnd(payload.id, payload.laneId, laneId, addedIndex, newCard) : true;
